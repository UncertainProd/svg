...
class Gfx2Haxe extends Gfx
{
	...
	{
		commands.push("g.beginGradientFill(" + grad.type + "," + grad.colors + "," + grad.alphas + "," + grad.ratios + "," + newMatrix(grad.matrix) + ","
			+ grad.spread + "," + grad.interp + "," + grad.focus + ");");
	}
	...
	{
		commands.push("g.lineStyle(" + f2a(style.thickness) + "," + style.color + "," + f2a(style.alpha) + "," + style.pixelHinting + "," + style.scaleMode
			+ "," + style.capsStyle + "," + style.jointStyle + "," + f2a(style.miterLimit) + ");");
	}

	override public function endLineStyle()
	{
		commands.push("g.lineStyle();");
	}
